...
layui.define(['jquery','layer'],function(exports){
  ...
  ,thisinputTags = function(){
    ...
    return {
      config: options,
	  getValue:function(){
		  var s = $(options.elem.selector).parent().find('em');
  ...
  Class.prototype.events = function(){
    ...
    options.elem.selector
    $(options.elem.selector).parent().on('click','.close',function(){
...
}).link('static/js/lay-module/mymodules/inputTags.css')